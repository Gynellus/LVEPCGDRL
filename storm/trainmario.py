import gymnasium
import argparse
import gymnasium.wrappers.step_api_compatibility
...
def joint_train_world_model_agent(env_name, max_steps, num_envs, image_size,
    ...
    for total_steps in tqdm(range(max_steps//num_envs)):
        ...
        if replay_buffer.ready():
            ...
            # current_obs = torch.Tensor(current_obs).unsqueeze(0).cuda()
            context_obs.append(rearrange(torch.Tensor(current_obs).cuda(), "B H W C -> B 1 C H W")/255) # "B H W C -> B 1 C H W"
